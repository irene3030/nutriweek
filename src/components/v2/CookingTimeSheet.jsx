              ...
              {readyProposals.length > 0 && (
                <div className="space-y-3">
                  ...
                  {readyProposals.map((p, i) => (
                    <SuggestedPrepCard key={i} proposal={p} inventoryItems={inventoryItems} onSelect={onSelect} onSchedule={onSchedule} selectLabel="Cocinar" />
                  ))}
                </div>
              )}
              ...
              {baseProposals.length > 0 && (
                <div className="space-y-3">
                  ...
                  {baseProposals.map((p, i) => (
                    <SuggestedPrepCard key={i} proposal={p} inventoryItems={inventoryItems} onSelect={onSelect} onSchedule={onSchedule} selectLabel="Preparar base" />
                  ))}
                </div>
              )}
